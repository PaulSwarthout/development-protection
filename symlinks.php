 ...
 * 
 * To resolve that issue, all of my plugins include the following required file.
 * 
...
function is_symlink( $file ) {
	return ! strpos( wp_normalize_path( WP_CONTENT_DIR ), wp_normalize_path( dirname( $file ) ) );
}
